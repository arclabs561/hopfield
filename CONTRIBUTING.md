# Contributing to hopfield

Thanks for your interest. hopfield is dense associative memory and modern Hopfield networks.
...
- Commit messages: `hopfield: short lowercase description`. One commit per logical change.
